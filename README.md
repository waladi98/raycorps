# [Yarsi Smart Campus](https://demos.creative-tim.com/material-dashboard-pro-angular2/)
...
Yarsi Smart Campus is a Premium Material Bootstrap 4 Admin with a fresh, new design inspired by Google's Material Design. It is based on the popular Bootstrap 4 framework and comes packed with multiple third-party plugins. All components are built to fit perfectly with each other, while aligning to the material concepts.

Yarsi Smart Campus makes use of light, surface and movement. The general layout resembles sheets of paper following multiple layers, so that the depth and order is obvious. Inside the archive you will find multiple example pages on how to use all components. And, of course, every element is documented.
...
Yarsi Smart Campus has the same line of design as the Material Kit PRO, so they go together quite good. If you think you will need more landing and example pages, be sure to check it out. If you love material design, you'll probably enjoy using these products!
...
- Buy from [KPM Tim](https://www.creative-tim.com/product/material-dashboard-pro-angular2).
...
## Documentation
The documentation for the Yarsi Smart Campus is hosted at our [website](https://demos.creative-tim.com/material-dashboard-pro-angular2/documentation/tutorial).
...
## Reporting Issues
We use GitHub Issues as the official bug tracker for the Yarsi Smart Campus. Here are some advices for our users that want to report an issue:

1. Make sure that you are using the latest version of the Yarsi Smart Campus. Check the CHANGELOG from your dashboard on our [website](https://www.creative-tim.com/).
...
- Copyright 2018 KPM Tim (https://www.creative-tim.com)
- KPM Tim [license](https://www.creative-tim.com/license)

## Useful Links

- [More products](https://www.creative-tim.com/bootstrap-themes/angular-themes) from KPM Tim

- [Tutorials](https://www.youtube.com/channel/UCVyTG4sCw-rOvB9oHkzZD1w)

- [Freebies](https://www.creative-tim.com/bootstrap-themes/free) from KPM Tim
