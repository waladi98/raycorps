  ...
  helloShow() {
    ...
    swal
      .fire({
        ...
        html: '<h6> <b>' + this.listDataSalam.salam + '</b></h6> </br> <b>Selamat datang di SMART CAMPUS YARSI</b> </br><b>Sistem Registrasi</b>',
        width: 470,
        // icon: "success",
        customClass: {
  ...
  inisialisasiTable() {
    this.listData = {
      ...
      header: [
        ...
        {
          tooltip: 'Calon pendaftar yang batal dikarenakan data ganda atau data testing',
          type: '',
          label: 'Tanggal Masuk',
          class: 'text-sm text-center border border-black-300 bg-gray-400',
          field: 'batal',
