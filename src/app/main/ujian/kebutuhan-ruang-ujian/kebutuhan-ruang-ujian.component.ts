...
@Component({
    selector: 'app-master-kebutuhan-ruang-ujian',
    templateUrl: 'kebutuhan-ruang-ujian.component.html'
})

export class KebutuhanRuangUjianComponent implements OnInit {
    ...
    manageData(module) {
        if (module) {
            this.router.navigate(['/master-data/manage-kebutuhan-ruang-ujian/' + module.kode]);
        } else {
            this.router.navigate(['/master-data/manage-kebutuhan-ruang-ujian']);
        }
    }
