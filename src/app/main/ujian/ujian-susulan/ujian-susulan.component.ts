...
@Component({
    selector: 'app-master-ujian-susulan',
    templateUrl: 'ujian-susulan.component.html'
})

export class UjianSusulanComponent implements OnInit {
    ...
    manageData(module) {
        if (module) {
            this.router.navigate(['/master-data/manage-ujian-susulan/' + module.kode]);
        } else {
            this.router.navigate(['/master-data/manage-ujian-susulan']);
        }
    }
