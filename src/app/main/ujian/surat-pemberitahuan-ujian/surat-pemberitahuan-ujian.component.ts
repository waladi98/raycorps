...
@Component({
    selector: 'app-master-surat-pemberitahuan-ujian',
    templateUrl: 'surat-pemberitahuan-ujian.component.html'
})

export class SuratPemberitahuanUjianComponent implements OnInit {
