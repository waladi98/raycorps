...
@Component({
    selector: 'app-master-institusi',
    templateUrl: 'institusi.component.html'
})


export class InstitusiComponent implements OnInit {
    ...
    manageData(module) {
        if (module) {
			this.router.navigate(['/master-data/manage-institusi/' + module.kode]);
        } else {
            this.router.navigate(['/master-data/manage-institusi']);
        }
      }
    ...
    loadData(page: number): void {
        ...
        this.dataService
            .getPostRequest<any>('/master/institusi', {
                offset: page,
                limit: this.pageSize
            })
            .pipe(
