...
export class KampusComponent implements OnInit {
    ...
    manageData(module) {
        if (module) {
            this.router.navigate(['/master-data/manage-kampus/' + module.kode]);
        } else {
            this.router.navigate(['/master-data/manage-kampus']);
        }
    }
    ...
    loadData(page: number): void {
        ...
        this.dataService
            .getPostRequest<any>('/master/kampus', {
                offset: page,
                limit: this.pageSize
            })
            .pipe(
