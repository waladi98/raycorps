...
@Component({
    selector: 'app-master-pimpinan',
    templateUrl: 'pimpinan.component.html'
})

export class PimpinanComponent implements OnInit {
    ...
    manageData(module) {
        if (module) {
            this.router.navigate(['/master-data/manage-pimpinan/' + module.kode]);
        } else {
            this.router.navigate(['/master-data/manage-pimpinan']);
        }
    }
