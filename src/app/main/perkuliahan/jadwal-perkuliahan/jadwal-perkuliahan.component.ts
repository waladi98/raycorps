...
@Component({
    selector: 'app-master-jadwal-perkuliahan',
...
export class JadwalPerkuliahanComponent implements OnInit {
    ...
    manageData(module) {
        if (module) {
            this.router.navigate(['/master-data/manage-jadwal-perkuliahan/' + module.kode]);
        } else {
            this.router.navigate(['/master-data/manage-jadwal-perkuliahan']);
        }
    }
