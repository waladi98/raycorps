...
@Component({
  ...
  templateUrl: 'akd-jadwal-mhs-wali-dosen.component.html',
  styleUrls: ['./akd-jadwal-mhs-wali-dosen.component.scss'],
  styles: [
    `
      md-calendar {
        width: 300px;
...
export class AkdJadwalMhsWaliDosenComponent implements OnInit {
