...
@Component({
    selector: 'app-master-persetujuan-pembimbing',
    templateUrl: 'persetujuan-pembimbing.component.html'
})

export class PersetujuanPembimbingComponent implements OnInit {
