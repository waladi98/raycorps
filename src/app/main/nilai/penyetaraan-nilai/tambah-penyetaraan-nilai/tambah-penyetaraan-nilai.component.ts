...
@Component({
  selector: 'app-tambah-penyetaraan-nilai',
  templateUrl: './tambah-penyetaraan-nilai.component.html',
  styleUrls: ['./tambah-penyetaraan-nilai.component.scss'],
})
export class TambahPenyetaraanNilaiComponent implements OnInit {
  matakuliah = [
