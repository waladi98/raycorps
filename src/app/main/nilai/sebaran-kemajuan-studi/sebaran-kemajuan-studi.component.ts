...
@Component({
  selector: 'app-master-sebaran-kemajuan-studi',
  templateUrl: 'sebaran-kemajuan-studi.component.html',
})
export class SebaranKemajuanStudiComponent implements OnInit {
