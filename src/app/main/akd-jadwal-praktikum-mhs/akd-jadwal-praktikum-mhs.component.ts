...
@Component({
  ...
  templateUrl: 'akd-jadwal-praktikum-mhs.component.html',
  styleUrls: ['./akd-jadwal-praktikum-mhs.component.scss'],
  styles: [
    `
      md-calendar {
        width: 300px;
...
export class AkdJadwalPraktikumMhsComponent implements OnInit {
