...
@Component({
    selector: 'app-master-rekap-perwalian-per-dosen-wali',
    templateUrl: 'rekap-perwalian-per-dosen-wali.component.html'
})

export class RekapPerwalianPerDosenWaliComponent implements OnInit {
    ...
    manageData(module) {
        if (module) {
            this.router.navigate(['/registrasi/rekap-perwalian-per-dosen-wali/' + module.kode]);
        } else {
            this.router.navigate(['/registrasi/rekap-perwalian-per-dosen-wali']);
        }
    }
