...
@Component({
    selector: 'app-master-manage-status-perwalian',
    templateUrl: 'manage-status-perwalian.component.html'
})

export class ManageStatusPerwalianComponent implements OnInit {
