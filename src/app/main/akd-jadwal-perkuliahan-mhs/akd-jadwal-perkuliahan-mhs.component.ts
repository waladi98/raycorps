...
@Component({
  ...
  templateUrl: 'akd-jadwal-perkuliahan-mhs.component.html',
  styleUrls: ['./akd-jadwal-perkuliahan-mhs.component.scss'],
  styles: [
    `
      md-calendar {
        width: 300px;
...
export class AkdJadwalPerkuliahanMhsComponent implements OnInit {
