...
@Component({
  selector: 'app-nilai-persemester',
  templateUrl: 'nilai-persemester.component.html',
  styleUrls: ['./nilai-persemester.component.scss'],
  styles: [
    `
      md-calendar {
        width: 300px;
...
export class NilaiPerSemesterComponent implements OnInit {
  listData = {
    header: [],
    field: [],
    action: [],
  ...
  inisialisasiTable() {
    this.listData = {
      ...
      data: [
        ...
        {
          kode_matkul: 'IF161201',
          matakuliah: 'INTERNET DAN TEKNOLOGI WEB',
          sks: '3',
          grade: 'B',
          bobot: '3.00',
          ekivalensi: '-',
