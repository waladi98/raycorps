...
export class JabatanComponent implements OnInit {
  ...
  manageData(data) {
    const dialogRef = this.dialog.open(TambahJabatanComponent, {
      data: {
        type: data,
      },
    });
  ...
  inisialisasiTable() {
    this.listData = {
      ...
      header: [
        ...
        {
          type: "",
          label: 'Tunjangan Ikatan',
          class: 'text-sm text-center border border-black-300 bg-gray-400',
          field: 'tunjangan_ikatan',
          filter: false,
          filter_type: "text",
          filter_value: null,
          sort: false,
      ...
      data: [
        {
          ...
          jabatan_dikti: '=JabatanDikti=',
          golongan: '=Golongan=',
          tunjangan_ikatan: '=TunjanganIkatan=',
          tanggal_mulai: '=TanggalMulai=',
          sk_jabatan: '=SKJabatan=',
          sk_golongan: '=SKGolongan=',
        },
      ],
    };
  }
