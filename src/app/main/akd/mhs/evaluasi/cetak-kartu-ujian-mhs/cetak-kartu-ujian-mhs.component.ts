...
@Component({
  ...
  templateUrl: 'cetak-kartu-ujian-mhs.component.html',
  styleUrls: ['./cetak-kartu-ujian-mhs.component.scss'],
  styles: [
    `
      md-calendar {
        width: 300px;
...
export class CetakKartuUjianMhsComponent implements OnInit {
    ...
    this.listData = {
      ...
      data: [
        ...
        },
        {
          ...
          prodi: 'Teknik Informatika',
          kode_mk: 'IF21W0406',
          matakuliah: 'Sistem Berorientasi Objek',
          kelas: 'V',
          adm: 'V',
          kmhs: 'V',
          lab: 'V',
