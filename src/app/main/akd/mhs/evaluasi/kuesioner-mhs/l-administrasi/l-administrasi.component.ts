...
@Component({
  selector: 'app-l-administrasi',
  templateUrl: 'l-administrasi.component.html',
  styleUrls: ['./l-administrasi.component.scss'],
  styles: [
    `
      md-calendar {
        width: 300px;
...
export class LAdministrasiComponent implements OnInit {
  listData = {
    header: [],
    field: [],
    action: [],
  ...
  inisialisasiTable() {
    this.listData = {
      header: [
        {
          label: '#',
          class: 'text-sm text-center border border-black-300 bg-header-table text-white w-0',
          field: 'no',
        },
        {
          label: 'ID',
        ...
        },
        {
          ...
          class: 'text-sm text-center border border-black-300 bg-header-table text-white w-10',
          field: 'uraian_pertanyaan',
        },
        {
          label: 'Nilai',
          class: 'text-sm text-center border border-black-300 bg-header-table text-white w-50',
          field: 'nilai',
        },
      ],
      field: [
