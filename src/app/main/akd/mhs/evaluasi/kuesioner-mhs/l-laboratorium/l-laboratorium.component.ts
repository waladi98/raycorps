...
@Component({
  selector: 'app-l-laboratorium',
  templateUrl: 'l-laboratorium.component.html',
  styleUrls: ['./l-laboratorium.component.scss'],
  styles: [
    `
      md-calendar {
        width: 300px;
...
export class LLaboratoriumComponent implements OnInit {
  listData = {
    header: [],
    field: [],
    action: [],
