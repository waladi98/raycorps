...
@Component({
  selector: 'app-l-kemahasiswaan',
  templateUrl: 'l-kemahasiswaan.component.html',
  styleUrls: ['./l-kemahasiswaan.component.scss'],
  styles: [
    `
      md-calendar {
        width: 300px;
...
export class LKemahasiswaanComponent implements OnInit {
  listData = {
    header: [],
    field: [],
    action: [],
