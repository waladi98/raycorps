...
@Component({
  selector: 'app-pengisian-krs',
  templateUrl: 'pengisian-krs.component.html',
  styleUrls: ['./pengisian-krs.component.scss'],
  styles: [
    `
      md-calendar {
        width: 300px;
...
export class PengisianKRSComponent implements OnInit {
  ...
  params: any;
  constructor(private _activatedRoute: ActivatedRoute, public breakpointObserver: BreakpointObserver, private router: Router) {
