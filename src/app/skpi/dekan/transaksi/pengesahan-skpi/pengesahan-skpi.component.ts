...
@Component({
  selector: 'app-skpi-pengesahan-skpi',
  templateUrl: 'pengesahan-skpi.component.html',
  styleUrls: ['./pengesahan-skpi.component.scss'],
  styles: [
    `
      md-calendar {
        width: 300px;
...
export class PengesahanSKPIComponent implements OnInit {
