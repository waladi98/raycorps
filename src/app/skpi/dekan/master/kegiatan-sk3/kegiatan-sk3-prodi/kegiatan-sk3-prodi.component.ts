...
@Component({
  selector: "app-skpi-dekan-kegiatan-sk3-prodi",
  templateUrl: "kegiatan-sk3-prodi.component.html",
  styleUrls: ["./kegiatan-sk3-prodi.component.scss"],
  styles: [
    `
      md-calendar {
        width: 300px;
...
export class KegiatanSK3ProdiComponent implements OnInit {
