...
@Component({
  selector: "app-skpi-referensi-status-pengusulan",
  templateUrl: "status-pengusulan.component.html",
  styleUrls: ["./status-pengusulan.component.scss"],
  styles: [
    `
      md-calendar {
        width: 300px;
...
export class StatusPengusulanComponent implements OnInit {
