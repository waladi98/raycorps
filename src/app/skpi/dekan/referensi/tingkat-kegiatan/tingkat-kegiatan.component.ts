...
@Component({
  selector: "app-skpi-referensi-tingkat-kegiatan",
  templateUrl: "tingkat-kegiatan.component.html",
  styleUrls: ["./tingkat-kegiatan.component.scss"],
  styles: [
    `
      md-calendar {
        width: 300px;
...
export class TingkatKegiatanComponent implements OnInit {
