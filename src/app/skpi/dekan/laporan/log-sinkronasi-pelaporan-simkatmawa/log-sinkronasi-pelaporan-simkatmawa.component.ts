...
@Component({
  selector: "app-skpi-log-sinkronasi-pelaporan-simkatmawa",
  templateUrl: "log-sinkronasi-pelaporan-simkatmawa.component.html",
  styleUrls: ["./log-sinkronasi-pelaporan-simkatmawa.component.scss"],
  styles: [
    `
      md-calendar {
        width: 300px;
...
export class LogSinkronasiComponent implements OnInit {
