...
@Component({
  selector: "app-skpi-verifikasi-usulan-skpi",
  templateUrl: "verifikasi-usulan-skpi.component.html",
  styleUrls: ["./verifikasi-usulan-skpi.component.scss"],
  styles: [
    `
      md-calendar {
        width: 300px;
...
export class VerifikasiUsulanSKPIComponent implements OnInit {
      ...
      action: [
        {
          ...
          toolTip: "Edit Verifikasi Kegiatan Usulan SKPI",
        },
      ],
      data: [
        {
