...
@Component({
  selector: "app-skpi-usulan-skpi",
  templateUrl: "usulan-skpi.component.html",
  styleUrls: ["./usulan-skpi.component.scss"],
  styles: [
    `
      md-calendar {
        width: 300px;
...
export class UsulanSKPIComponent implements OnInit {
