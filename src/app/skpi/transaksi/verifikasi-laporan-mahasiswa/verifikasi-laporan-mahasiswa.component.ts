...
@Component({
  selector: 'app-skpi-verifikasi-laporan-mahasiswa',
  templateUrl: 'verifikasi-laporan-mahasiswa.component.html',
  styleUrls: ['./verifikasi-laporan-mahasiswa.component.scss'],
  styles: [
    `
      md-calendar {
        width: 300px;
...
export class VerifikasiLaporanMahasiswaComponent implements OnInit {
