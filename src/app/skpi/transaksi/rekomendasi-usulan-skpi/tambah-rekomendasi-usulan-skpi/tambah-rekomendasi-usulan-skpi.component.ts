...
@Component({
  selector: "app-tambah-rekomendasi-usulan-skpi",
  templateUrl: "./tambah-rekomendasi-usulan-skpi.component.html",
  styleUrls: ["./tambah-rekomendasi-usulan-skpi.component.scss"],
})
export class TambahRekomendasiUsulanSKPIComponent implements OnInit {
