...
@Component({
  selector: "app-verifikasi-kegiatan-sk3-menu",
  templateUrl: "./verifikasi-kegiatan-sk3.component.html",
  styleUrls: ["./verifikasi-kegiatan-sk3.component.scss"],
})
export class MenuVerifikasiKegiatanSK3Component implements OnInit {
  ...
  toHome() {
    ...
    if (home) {
      this.router.navigate(["skpi/transaksi/verifikasi-kegiatan-sk3"]);
    }
  }
  ...
  toTable() {
    var home = localStorage.getItem("home");
    if (home) {
      this.router.navigate(["skpi/transaksi/no-sk"]);
    }
  }
