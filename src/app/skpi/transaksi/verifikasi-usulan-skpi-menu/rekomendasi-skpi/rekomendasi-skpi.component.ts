...
@Component({
  selector: 'app-rekomendasi-skpi',
  templateUrl: 'rekomendasi-skpi.component.html',
  styleUrls: ['./rekomendasi-skpi.component.scss'],
  styles: [
    `
      md-calendar {
        width: 300px;
...
export class RekomendasiSKPIComponent implements OnInit {
  formGroup: FormGroup;
