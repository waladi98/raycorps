...
@Component({
  selector: 'app-verifikasi-usulan-skpi-menu',
  templateUrl: 'verifikasi-usulan-skpi-menu.component.html',
  styleUrls: ['./verifikasi-usulan-skpi-menu.component.scss'],
  styles: [
    `
      md-calendar {
        width: 300px;
...
export class MenuVerifikasiUsulanSKPIComponent implements OnInit {
