...
@Component({
  selector: "app-skpi-aturan-penilaian-sk3",
  templateUrl: "aturan-penilaian-sk3.component.html",
  styleUrls: ["./aturan-penilaian-sk3.component.scss"],
  styles: [
    `
      md-calendar {
        width: 300px;
...
export class AturanPenilaianComponent implements OnInit {
