...
@Component({
  selector: "app-skpi-dekan-pengelolaan-aturan-sk3",
  templateUrl: "pengelolaan-aturan-sk3.component.html",
  styleUrls: ["./pengelolaan-aturan-sk3.component.scss"],
  styles: [
    `
      md-calendar {
        width: 300px;
...
export class PengelolaanAturanSK3Component implements OnInit {
