...
@Component({
  selector: "app-skpi-referensi-partisipasi",
  templateUrl: "partisipasi.component.html",
  styleUrls: ["./partisipasi.component.scss"],
  styles: [
    `
      md-calendar {
        width: 300px;
...
export class PartisipasiComponent implements OnInit {
