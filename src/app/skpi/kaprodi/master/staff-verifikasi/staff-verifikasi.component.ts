...
@Component({
  selector: "app-skpi-staff-verifikasi",
  templateUrl: "staff-verifikasi.component.html",
  styleUrls: ["./staff-verifikasi.component.scss"],
  styles: [
    `
      md-calendar {
        width: 300px;
...
export class StaffVerifikasiComponent implements OnInit {
