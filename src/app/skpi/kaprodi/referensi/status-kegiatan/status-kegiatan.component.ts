...
@Component({
  selector: "app-skpi-referensi-status-kegiatan",
  templateUrl: "status-kegiatan.component.html",
  styleUrls: ["./status-kegiatan.component.scss"],
  styles: [
    `
      md-calendar {
        width: 300px;
...
export class StatusKegiatanComponent implements OnInit {
