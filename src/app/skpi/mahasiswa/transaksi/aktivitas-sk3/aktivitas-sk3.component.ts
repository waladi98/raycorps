...
@Component({
  selector: "app-skpi-aktivitas-sk3",
  templateUrl: "aktivitas-sk3.component.html",
  styleUrls: ["./aktivitas-sk3.component.scss"],
  styles: [
    `
      md-calendar {
        width: 300px;
...
export class AktivitasSK3Component implements OnInit {
