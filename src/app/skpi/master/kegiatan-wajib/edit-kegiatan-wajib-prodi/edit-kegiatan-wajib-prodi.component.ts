...
@Component({
  selector: "app-edit-kegiatan-wajib-prodi",
  templateUrl: "./edit-kegiatan-wajib-prodi.component.html",
  styleUrls: ["./edit-kegiatan-wajib-prodi.component.scss"],
})
export class EditKegiatanWajibProdiComponent implements OnInit {
