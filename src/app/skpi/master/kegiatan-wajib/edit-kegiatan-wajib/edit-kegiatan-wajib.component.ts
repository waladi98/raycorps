...
@Component({
  selector: "app-edit-kegiatan-wajib",
  templateUrl: "./edit-kegiatan-wajib.component.html",
  styleUrls: ["./edit-kegiatan-wajib.component.scss"],
})
export class EditKegiatanWajibComponent implements OnInit {
  ...
  toHome() {
    ...
    if (home) {
      this.router.navigate(["skpi/master/kegiatan-sk3"]);
    }
  }
          ...
          .subscribe(
            (success) => {
              if (success.message == "Invalid Parameter") {
                swal.fire({
                  title: "Edit Kegiatan SK3",
                  text: "Data Kegiatan SK3 Gagal di Ubah.",
                  icon: "error",
                  customClass: {
                ...
                swal
                  .fire({
                    title: "Edit Kegiatan SK3",
                    text: "Data Kegiatan SK3 Berhasil di Ubah.",
                    icon: "success",
                    customClass: {
                      confirmButton: "btn btn-success",
                    },
