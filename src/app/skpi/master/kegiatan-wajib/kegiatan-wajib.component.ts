...
@Component({
  selector: "app-skpi-dekan-kegiatan-wajib",
  templateUrl: "kegiatan-wajib.component.html",
  styleUrls: ["./kegiatan-wajib.component.scss"],
  styles: [
    `
      md-calendar {
        width: 300px;
...
export class KegiatanWajibComponent implements OnInit {
  ...
  toAdd(){
    ...
    if (home) {
      this.router.navigate(["skpi/master/kegiatan-wajib/tambah"]);
    }
  }
  ...
  inisialisasiTable() {
    this.listData = {
      ...
      action: [
        {
          id_params: "",
          route: "skpi/master/kegiatan-wajib/edit",
          type: "route",
        ...
        list: [
          {
            ...
            data: {
              add_data: {
                type: "route",
                route: "skpi/master/kegiatan-wajib/tambah-prodi",
              },
              is_action: true,
              filter: false,
              init_load: true,
