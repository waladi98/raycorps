...
@Component({
  selector: "app-tambah-kegiatan-wajib-prodi",
  templateUrl: "./tambah-kegiatan-wajib-prodi.component.html",
  styleUrls: ["./tambah-kegiatan-wajib-prodi.component.scss"],
})
export class TambahKegiatanWajibProdiComponent implements OnInit {
