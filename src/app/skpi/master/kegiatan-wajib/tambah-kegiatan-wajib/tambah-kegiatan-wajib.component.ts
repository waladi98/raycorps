...
@Component({
  selector: "app-tambah-kegiatan-wajib",
  templateUrl: "./tambah-kegiatan-wajib.component.html",
  styleUrls: ["./tambah-kegiatan-wajib.component.scss"],
})
export class TambahKegiatanWajibComponent implements OnInit {
