...
@Component({
  selector: "app-tambah-kegiatan-tingkat",
  templateUrl: "./tambah-kegiatan-tingkat.component.html",
  styleUrls: ["./tambah-kegiatan-tingkat.component.scss"],
})
export class TambahKegiatanTingkatComponent implements OnInit {
