...
@Component({
  selector: "app-edit-aturan-sk3",
  templateUrl: "./edit-aturan-sk3.component.html",
  styleUrls: ["./edit-aturan-sk3.component.scss"],
})
export class EditAturanSK3Component implements OnInit {
          ...
          .subscribe(
            (success) => {
              if (success.message == "Invalid Parameter") {
                swal.fire({
                  title: "Edit Aturan SK3",
                  text: "Data Aturan SK3 Gagal di Tambahkan.",
                  icon: "error",
                  customClass: {
                ...
                swal
                  .fire({
                    title: "Edit Aturan SK3",
                    text: "Data Aturan SK3 Berhasil di Tambahkan.",
                    icon: "success",
                    customClass: {
                      confirmButton: "btn btn-success",
                    },
  ...
  cancel(data) {
    this.router.navigate(["/skpi/master/aturan-sk3"]);
  }
}
