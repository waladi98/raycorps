...
@Component({
  selector: "app-tambah-aturan-sk3",
  templateUrl: "./tambah-aturan-sk3.component.html",
  styleUrls: ["./tambah-aturan-sk3.component.scss"],
})
export class TambahAturanSK3Component implements OnInit {
