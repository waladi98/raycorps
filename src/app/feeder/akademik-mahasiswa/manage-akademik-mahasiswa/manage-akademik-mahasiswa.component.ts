...
@Component({
    selector: 'app-master-manage-akademik-mahasiswa',
    templateUrl: 'manage-akademik-mahasiswa.component.html'
})

export class ManageAkademikMahasiswaComponent implements OnInit {
    ...
    getDetailData(kode): void {
        ...
        this.dataService
            .getRequest<any>('/master/akademik-mahasiswa/show', {
                kode: kode,
            })
            .pipe(
