...
@Component({
  ...
  templateUrl: "./dashboard-anggaran.component.html",
})
export class DashboardAnggaranComponent implements OnInit, AfterViewInit {
  constructor(
  ...
  public ngOnInit() {
    ...
    const RoundedLineChart = new Chartist.Line(
      "#roundedLineChart",
    ...
    const straightLinesChart = new Chartist.Line(
      "#straightLinesChart",
    ...
    const dataPreferences = {
      labels: ["79.9%", "18.4%", "0.5%", "0.7%"],
      series: [79.9, 18.4, 0.5, 0.7],
    };
    ...
    swal
      .fire({
        ...
        html:
          ...
          "</b></h6> </br> <b>Selamat datang di SMART CAMPUS YARSI</b> </br><b>Sistem Anggaran</b>",
        width: 470,
        // icon: "success",
        customClass: {
          confirmButton: "btn btn-success",
