...
export class DashboardComponent implements OnInit, AfterViewInit {
  ...
  listDataStatusPegawai: CustomTable;
    ...
    swal
      .fire({
        ...
        html:
          ...
          "</b></h6> </br> <b>Selamat datang di SMART CAMPUS YARSI</b> </br><b>Sistem Kepegawaian</b>",
        width: 470,
        // icon: "success",
        customClass: {
  ...
  inisialisasiTableStatus() {
    this.listDataStatusPegawai = {
      filter: false,
      init_load: false,
      is_role: false,
      is_role_params: {
