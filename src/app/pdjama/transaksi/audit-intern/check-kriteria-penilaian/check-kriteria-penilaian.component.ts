...
@Component({
  selector: "app-check-kriteria-penilaian",
  templateUrl: "./check-kriteria-penilaian.component.html",
  styleUrls: ["./check-kriteria-penilaian.component.scss"],
})
export class CheckKriteriaPenilaianComponent implements OnInit {
  ...
  params: any;
  FormKriteriaPenilaianComponent = FormKriteriaPenilaianComponent;
  formGroup: FormGroup;
  ...
  ngOnInit() {
    ...
    this._storageService.set(
      "path_menu_master",
      "pdjama/transaksi/audit-internall/kriteria-penilaian/18"
    );
  }
  ...
  inisialisasiTable() {
    this.listData = {
      action_selected: [
        {
          label: "Tambahkan",
          id_params: "kode",
          id_params_local: this.audit_internal_id,
          type: "dialog",
          controller: "FormKriteriaPenilaianComponent",
        },
        // {
        //   label: "Update",
        //   id_params: "kode",
        //   api: {
        //     endpoint: "pdjama/master/bidang/modify",
        //   },
        // },
      ],
      // add_data: {
      ...
      is_where: true,
      where:
        "NOT EXISTS (SELECT * FROM jv_kriteria_audit WHERE jv_kriteria_penilaian.kode = jv_kriteria_audit.kode_kriteria_penilaian AND jv_kriteria_audit.audit_internal_id = " +
        this.audit_internal_id +
        ") ",
      group: "",
      pageSize: 5,
      ...
      filter_data: [
        {
          id: "kode_daftar_periksa_audit",
          label: "Daftar Periksa Audit",
          data_list: [],
          type: "select",
          is_filter: true,
          value: null,
