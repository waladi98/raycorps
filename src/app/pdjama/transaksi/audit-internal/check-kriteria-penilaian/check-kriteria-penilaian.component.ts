...
export class CheckKriteriaPenilaianComponent implements OnInit {
  ...
  inisialisasiTable() {
    this.listData = {
      action_selected: [
        {
          ...
          api: {
            endpoint: "pdjama/master/bidang/remove",
          },
        },
        // {
        //   label: "Update",
      ...
      order: "",
      is_where: true,
      where: "NOT EXISTS (SELECT * FROM jv_kriteria_audit WHERE jv_kriteria_penilaian.kode = jv_kriteria_audit.kode_kriteria_penilaian AND jv_kriteria_audit.audit_internal_id = 18) ",
      group: "",
      pageSize: 5,
