...
@Component({
  selector: "app-audit-internal",
  templateUrl: "audit-internal.component.html",
  styleUrls: ["./audit-internal.component.scss"],
  styles: [
    `
      md-calendar {
        width: 300px;
...
export class AuditInternalComponent implements OnInit {
  ...
  inisialisasiTable() {
    this.listData = {
      ...
      action: [
        {
          id_params: "id",
          route: "/pdjama/transaksi/audit-internal/kriteria-penilaian",
          type: "route",
