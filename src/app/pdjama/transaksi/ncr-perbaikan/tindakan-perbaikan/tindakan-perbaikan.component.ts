...
@Component({
  selector: "app-tindakan-perbaikan",
  templateUrl: "tindakan-perbaikan.component.html",
  styleUrls: ["./tindakan-perbaikan.component.scss"]
})
export class TindakanPerbaikanComponent implements OnInit {
  formGroup: FormGroup;
  asalSekolahList;
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<TindakanPerbaikanComponent>,
