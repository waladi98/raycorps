...
import { TindakanPerbaikanComponent } from "./tindakan-perbaikan/tindakan-perbaikan.component";
...
@Component({
  selector: "app-ncr-perbaikan",
  templateUrl: "ncr-perbaikan.component.html",
  styleUrls: ["./ncr-perbaikan.component.scss"],
  styles: [
    `
      md-calendar {
        width: 300px;
...
export class NCRPerbaikanComponent implements OnInit {
  ...
  params: any;
  TindakanPerbaikanComponent = TindakanPerbaikanComponent;
  constructor(
