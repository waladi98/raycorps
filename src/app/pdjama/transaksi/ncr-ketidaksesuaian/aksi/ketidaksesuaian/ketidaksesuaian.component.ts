...
@Component({
  selector: "app-ketidaksesuaian",
  templateUrl: "ketidaksesuaian.component.html",
  styleUrls: ["./ketidaksesuaian.component.scss"]
})
export class VerifikasiPerbaikanComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.formGroup = this.formBuilder.group({
      no_ncr: ["", Validators.required],
      ref_prosedur: ["", Validators.required],
      dasar_ncr: ["", Validators.required],
      institusi: ["", Validators.required],
      Ketidaksesuaian: ["", Validators.required],
      status_verifikasi: ["", Validators.required],
      nama_auditor: ["", Validators.required],
    });
  }
  ...
  selectAuditor(data) {
    this.formGroup.get("kode_auditor").setValue(data.kode);
    this.formGroup.get("nama_auditor").setValue(data.nama_auditor);
  }

  doFilterAuditor(searchValue: string) {
