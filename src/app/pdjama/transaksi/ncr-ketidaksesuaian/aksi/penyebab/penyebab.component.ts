...
@Component({
  selector: "app-penyebab",
  templateUrl: "penyebab.component.html",
  styleUrls: ["./penyebab.component.scss"]
})
export class PenyebabComponent implements OnInit {
