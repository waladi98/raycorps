...
@Component({
  selector: "app-ncr-verifikasi-perbaikan",
  templateUrl: "ncr-verifikasi-perbaikan.component.html",
  styleUrls: ["./ncr-verifikasi-perbaikan.component.scss"],
  styles: [
    `
      md-calendar {
        width: 300px;
...
export class NCRVerifikasiPerbaikanComponent implements OnInit {
