...
@Component({
  selector: "app-tindakan-lanjut",
  templateUrl: "tindakan-lanjut.component.html",
  styleUrls: ["./tindakan-lanjut.component.scss"]
})
export class TindakanLanjutComponent implements OnInit {
