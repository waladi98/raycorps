...
@Component({
  selector: "app-bidang",
  templateUrl: "bidang.component.html",
  styleUrls: ["./bidang.component.scss"],
  styles: [
    `
      md-calendar {
        width: 300px;
...
export class BidangComponent implements OnInit {
    ...
    this.listData = {
      ...
      field: [
        ...
        },
        {
          type: "",
          count_field: [],
          class: "text-left border border-black-300 w-28",
          field: "nama_bidang",
        },
