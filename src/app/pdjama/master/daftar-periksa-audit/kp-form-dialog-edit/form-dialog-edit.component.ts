...
export class FormDialogKPEditComponent implements OnInit {
  formGroup: FormGroup;
  dataMaster: any;
  listDataJenisMgm = [];
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<FormDialogKPEditComponent>,
  ...
  submitRequest(): void {
    ...
    let endpoint = "/pdjama/master/kriteriaPenilaian/modify";
