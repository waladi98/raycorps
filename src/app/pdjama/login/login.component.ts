  ...
  async loadInitData(username): Promise<any> {
    try {
      ...
      if (listDataKelompok.length > 0) {
        if (listDataKelompok[0].id_kelompok == "950") {
          route_dashboard = "/" + route_id + "/dashboard";
        } else if (listDataKelompok[0].id_kelompok == "951") {
          route_dashboard = "/" + route_id + "/dashboard";
        } else if (listDataKelompok[0].id_kelompok == "952") {
          route_dashboard = "/" + route_id + "/dashboard";
        } else if (listDataKelompok[0].id_kelompok == "953") {
          route_dashboard = "/" + route_id + "/dashboard";
        } else if (listDataKelompok[0].id_kelompok == "954") {
          route_dashboard = "/" + route_id + "/dashboard";
