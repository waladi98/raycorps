...
export class SmartGuard implements CanActivate, CanActivateChild, CanLoad {
  /**
   * Constructor
   */
  ...
  private _check(redirectURL: string): Observable<boolean> {
    var kode = this._storageService.get("kklien");
    var password = this._storageService.get("pklien");
