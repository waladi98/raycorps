...
export class InformasiLengkapPesertaComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    if (user_token) {
      this.srcdoc = this.sanitizer.bypassSecurityTrustResourceUrl('https://dev-yarsi.ddns.net/prototipe/pmb/frame_modul.php?user_token=' + user_token + '&modul=q_peserta');
    } else {
