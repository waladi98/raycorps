...
@Component({
  selector: "app-isi-formulir-pmb",
  templateUrl: "isi-formulir-pmb.component.html",
  styleUrls: ["./isi-formulir-pmb.component.scss"],
  styles: [
    `
      md-calendar {
        width: 300px;
...
export class IsiFormulirPmbComponent implements OnInit {
  formGroup: FormGroup;
