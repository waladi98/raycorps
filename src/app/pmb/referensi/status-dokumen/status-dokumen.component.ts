...
@Component({
  ...
  templateUrl: "status-dokumen.component.html",
  styleUrls: ["./status-dokumen.component.scss"],
  styles: [
    `
      md-calendar {
        width: 300px;
...
export class StatusDokumenComponent implements OnInit {
  ...
  loadData(page: number): void {
    ...
    this.dataService
      .getPostRequest<any>("/pmb/referensi/statusDokumen", {
        offset: page,
        limit: this.pageSize,
      })
      .pipe(
    ...
    swal
      ...
      .then((result) => {
        if (result.value) {
          swal.fire({
            title: "Dihapuskan!",
            text: "Status Dokumen Telah Dihapuskan.",
            icon: "success",
            customClass: {
              confirmButton: "btn btn-success",
            },
          ...
          swal.fire({
            title: "Dibatalkan",
            text: "Status Dokumen Tidak Jadi Dihapuskan",
            icon: "error",
            customClass: {
...
inisialisasiTable() {
  this.listData = {
    ...
    endpoint: '/pmb/referensi/statusDokumen',
    action_name: '',
    type: "",
    order: "",
    where: "",
...
// }
    ...
    field: [
      ...
      action: [
        {
          id_params: "id",
          route:"pmb/referensi/status-dokumen/ubah-status-dokumen",
          type: "route",
          icon: "fa fa-edit text-warning",
          toolTip: "Ubah Status Dokumen"
        },],
    data: [],
    export:[{
      type:"csv",
      label:"CSV",
      label_report:"report-ref-status-dokumen"
    },
    {
      type:"pdf",
      label:"PDF",
