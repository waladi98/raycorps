...
import { CustomTable } from "src/app/components/custom-table/custom-table.interface";
...
@Component({
  selector: "app-jas-almamater",
  templateUrl: "jas-almamater.component.html",
  styleUrls: ["./jas-almamater.component.scss"],
  styles: [
    `
      md-calendar {
        width: 300px;
...
export class JasAlmamaterComponent implements OnInit {
  ...
  loadData(page: number): void {
    ...
    this.dataService
      .getPostRequest<any>("/pmb/referensi/jasAlmamater", {
        offset: page,
        limit: this.pageSize,
      })
      .pipe(
  ...
  inisialisasiTable() {
    this.listData = {
      ...
      endpoint: "pmb/referensi/jasAlmamater",
      action_name: "",
      type: "",
      order: "",
      where: "",
      ...
      action: [
        {
          id_params: "id",
          route:"pmb/referensi/jas-almamater/ubah-jas-almamater",
          type: "route",
          icon: "fa fa-edit text-warning",
          toolTip: "Jas Almamater"
        },],
      data: [],
      export:[{
        type:"csv",
        label:"CSV",
        label_report:"report-ref-jas-almamater"
      },
      {
        type:"pdf",
        label:"PDF",
