...
export class DaftarPesertaPMBComponent implements OnInit {
  ...
  snackBarRef;
  noPmb = this._storageService.get("proses_kelengkapan");
  ...
  openSnackBar() {
    ...
    this.snackBarRef.afterDismissed().subscribe(() => {
      this._storageService.remove("proses_kelengkapan");
    });
  }
  verifyData() {
    this.router.navigate([
      "/pmb/transaksi/proses-kelengkapan/verifikasi-peserta",
    ]);
  }
    ...
    this.listData = {
      ...
      header: [
        ...
        },
        {
          ...
          label: "AKSI",
          class:
            "text-sm disabled-sorting text-center w-28 border border-black-300 bg-gray-400",
          field: "action",
          filter: false,
          filter_type: null,
          filter_value: null,
      ...
      action: [
        {
          ...
          route: "/pmb/transaksi/proses-kelengkapan/verifikasi-peserta",
          type: "route",
          icon: "fa fa-edit text-warning",
          toolTip: "Verifikasi Kelulusan Peserta",
          condition: [
            {
              params_1: "dokumen_kelengkapan",
              operator: "!=",
              params_2: null,
            },
          ],
