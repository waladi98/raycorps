...
export class DaftarPesertaPMBComponent implements OnInit {
  ...
  inisialisasiTable() {
    this.listData = {
      ...
      where:
        "syarat_lengkap = 'T' AND  proses_persyaratan = 'Y' AND (id_status_seleksi = '6' OR id_status_seleksi = '0') ",
      group: "",
      ...
      field: [
        ...
        },
        {
          count_field: [],
          type: "",
          class: "text-left border border-black-300 w-64 dokumen",
          field: "dokumen_persyaratan",
        },
        {
          count_field: [],
          type: "",
          class: "text-left border border-black-300 w-64",
          field: "catatan_proses",
        },
        {
          type: "",
      ...
      action: [
        {
          ...
          route: "/pmb/transaksi/proses-persyaratan/verifikasi-peserta",
          type: "route",
        ...
        {
          id_params: "formulir_id",
          route: "/pmb/transaksi/proses-persyaratan/informasi-lengkap-peserta",
          type: "route",
