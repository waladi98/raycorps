...
export class DaftarPesertaPMBComponent implements OnInit {
  ...
  snackBarRef;
  noPmb = this._storageService.get("proses_kelulusan");
  dataList = [
    {
      formulir_id: 123456,
      detail_nilai: [
  ...
  openSnackBar() {
    ...
    this.snackBarRef.afterDismissed().subscribe(() => {
      this._storageService.remove("proses_kelulusan");
    });
  }
  ...
  async inisialisasiTable(): Promise<any> {
    this.listData = {
      ...
      order: "id asc",
      where:
        "ikut_ujian = 'Y' AND lulus is null AND (id_status_seleksi = '7' OR id_status_seleksi = '4' OR id_status_seleksi = '5') ",
      group: "",
      ...
      field: [
        ...
        },
        {
          type: "",
          count_field: [],
          class: "text-left border border-black-300 w-42",
