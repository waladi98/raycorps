...
@Component({
  selector: "app-verifikasi-nilai-peserta",
  templateUrl: "verifikasi-nilai-peserta.component.html",
  styleUrls: ["./verifikasi-nilai-peserta.component.scss"],
  styles: [
    `
      md-calendar {
        width: 300px;
...
export class VerifikasiNilaiPesertaComponent implements OnInit {
  listData = {
    header: [],
    field: [],
    action: [],
  ...
  toRoute(data) {
    if (data) {
      this.router.navigate(["/pmb/transaksi/verifikasi-nilai"]);
    }
  }
}
