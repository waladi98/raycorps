...
@Component({
  selector: 'app-asal-sekolah-peserta',
  templateUrl: 'asal-sekolah-peserta.component.html',
  styleUrls: ['./asal-sekolah-peserta.component.scss'],
  styles: [
    `
      md-calendar {
        width: 300px;
...
export class AsalSekolahPesertaComponent implements OnInit {
  ...
  inisialisasiTable() {
    this.listData = {
      ...
      endpoint: 'pmb/pesertaAsalSekolah',
      action_name: '',
      type: "",  
      order: "",
      where: "",
      ...
      export:[{
        type:"csv",
        label:"CSV",
        label_report:"report-asal-sekolah"
      },
      {
        type:"pdf",
        label:"PDF",
