...
@Component({
  selector: 'app-asal-pt-peserta',
  templateUrl: 'asal-pt-peserta.component.html',
  styleUrls: ['./asal-pt-peserta.component.scss'],
  styles: [
    `
      md-calendar {
        width: 300px;
...
export class AsalPTPesertaComponent implements OnInit {
  ...
  inisialisasiTable() {
    this.listData = {
      ...
      endpoint: 'pmb/pesertaAsalPerguruanTinggi',
      action_name: '',
      type: "",  
      order: "",
      where: "",
