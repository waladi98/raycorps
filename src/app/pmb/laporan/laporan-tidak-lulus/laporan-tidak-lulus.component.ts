...
@Component({
  selector: "app-laporan-tidak-lulus",
  templateUrl: "laporan-tidak-lulus.component.html",
  styleUrls: ["./laporan-tidak-lulus.component.scss"],
  styles: [
    `
      md-calendar {
        width: 300px;
...
export class LaporanTidakLulusComponent implements OnInit {
  ...
  inisialisasiTable() {
    this.listData = {
      ...
      type: "",
      order: "",
      where: "syarat_lengkap = 'Y' AND id_status_seleksi = 2",
      group: "",
      dynamic_header_field: "",
      dynamic_header_name: "",
      dynamic_header_value: "",
      ...
      field: [
        ...
        },
        {
          type: "",
          count_field: [],
          class: "text-left border border-black-300 w-72 dokumen",
          field: "dokumen_persyaratan",
        },
        {
          type: "",
