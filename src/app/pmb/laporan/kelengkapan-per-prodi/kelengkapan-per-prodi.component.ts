...
@Component({
  selector: 'app-kelengkapan-per-prodi',
  templateUrl: 'kelengkapan-per-prodi.component.html',
  styleUrls: ['./kelengkapan-per-prodi.component.scss'],
  styles: [
    `
      md-calendar {
        width: 300px;
...
export class KelengkapanPerProdiComponent implements OnInit {
  ...
  inisialisasiTable() {
    this.listData = {
      ...
      endpoint: 'pmb/master/kelengkapanProdi',
      action_name: '',
      type: "",  
      order: "",
      where: "",
      ...
      export:[{
        type:"csv",
        label:"CSV",
        label_report:"report-kelengkapan-per-prodi"
      },
      {
        type:"pdf",
        label:"PDF",
