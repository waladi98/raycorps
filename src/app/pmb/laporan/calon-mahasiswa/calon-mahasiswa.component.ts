...
@Component({
  selector: 'app-calon-mahasiswa',
  templateUrl: 'calon-mahasiswa.component.html',
  styleUrls: ['./calon-mahasiswa.component.scss'],
  styles: [
    `
      md-calendar {
        width: 300px;
...
export class CalonMahasiswaComponent implements OnInit {
