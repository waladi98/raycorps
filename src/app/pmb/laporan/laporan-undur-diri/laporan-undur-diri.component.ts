...
@Component({
  selector: 'app-laporan-undur-diri',
  templateUrl: 'laporan-undur-diri.component.html',
  styleUrls: ['./laporan-undur-diri.component.scss'],
  styles: [
    `
      md-calendar {
        width: 300px;
...
export class LaporanUndurDiriComponent implements OnInit {
  ...
  inisialisasiTable() {
    this.listData = {
      ...
      export:[{
        type:"csv",
        label:"CSV",
        label_report:"report-calon-mahasiswa"
      },
      {
        type:"pdf",
        label:"PDF",
