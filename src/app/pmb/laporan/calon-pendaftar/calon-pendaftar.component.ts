...
@Component({
  selector: "app-calon-pendaftar",
  templateUrl: "calon-pendaftar.component.html",
  styleUrls: ["./calon-pendaftar.component.scss"],
  styles: [
    `
      md-calendar {
        width: 300px;
...
export class CalonPendaftarComponent implements OnInit {
  ...
  inisialisasiTable() {
    this.listData = {
      ...
      endpoint: "pmb/formulirOnlineAktif",
      action_name: "",
      type: "",
      order: "",
      where: "id_status_bayar = 'N'",
      group: "",
      ...
      export:[{
        type:"csv",
        label:"CSV",
        label_report:"report-calon-pendaftar"
      },
      {
        type:"pdf",
        label:"PDF",
