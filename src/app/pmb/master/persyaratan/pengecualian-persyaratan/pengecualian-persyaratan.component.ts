...
@Component({
  selector: 'app-pengecualian-persyaratan',
  templateUrl: 'pengecualian-persyaratan.component.html',
  styleUrls: ['./pengecualian-persyaratan.component.scss'],
  styles: [
    `
      md-calendar {
        width: 300px;
...
export class PengecualianPersyaratanComponent implements OnInit {
  listPengecualianPersyaratan = {
    header: [],
    field: [],
    action: [],
    data: [],
  ...
  managePengecualianPersyaratan(type) {
  ...
  ubahData(action_name) {
    this.router.navigateByUrl('ubah-persyaratan');
  }
  ...
  inisialisasiTable() {
    this.listPengecualianPersyaratan = {
      header: [
        {
          label: '#',
      ...
      action: [
        {
          action_name: 'managePengecualianPersyaratan',
