...
@Component({
  ...
  templateUrl: "komponen-nilai-dan-seleksi.component.html",
  styleUrls: ["./komponen-nilai-dan-seleksi.component.scss"],
  styles: [
    `
      md-calendar {
        width: 300px;
...
export class KomponenNilaiDanSeleksiComponent implements OnInit {
