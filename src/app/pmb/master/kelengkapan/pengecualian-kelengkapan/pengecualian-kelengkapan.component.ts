...
@Component({
  selector: 'app-pengecualian-kelengkapan',
  templateUrl: 'pengecualian-kelengkapan.component.html',
  styleUrls: ['./pengecualian-kelengkapan.component.scss'],
  styles: [
    `
      md-calendar {
        width: 300px;
...
export class PengecualianKelengkapanComponent implements OnInit {
