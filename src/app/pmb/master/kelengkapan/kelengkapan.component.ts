...
@Component({
  selector: "app-kelengkapan",
  templateUrl: "kelengkapan.component.html",
  styleUrls: ["./kelengkapan.component.scss"],
  styles: [
    `
      md-calendar {
        width: 300px;
...
export class KelengkapanComponent implements OnInit {
  ...
  ubahData() {
    this.router.navigate(["ubah-kelengkapan"], {
      relativeTo: this._activatedRoute,
    });
  }

  detailData() {
    this.router.navigate(["pengecualian-kelengkapan"], {
      relativeTo: this._activatedRoute,
    });
  }
...
inisialisasiTable() {
  this.listData = {
    ...
    endpoint: '/pmb/master/kelengkapan',
    action_name: '',
    type: "",
    order: "",
    where: "",
