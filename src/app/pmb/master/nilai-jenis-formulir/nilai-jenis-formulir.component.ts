...
@Component({
  selector: "app-nilai-jenis-formulir",
  templateUrl: "nilai-jenis-formulir.component.html",
  styleUrls: ["./nilai-jenis-formulir.component.scss"],
  styles: [
    `
      md-calendar {
        width: 300px;
...
export class NilaiJenisFormulirComponent implements OnInit {
  listData = {
    header: [],
    field: [],
    action: [],
