...
@Component({
  selector: "app-nilai-jenis-jurusan-sekolah",
  templateUrl: "nilai-jenis-jurusan-sekolah.component.html",
  styleUrls: ["./nilai-jenis-jurusan-sekolah.component.scss"],
  styles: [
    `
      md-calendar {
        width: 300px;
...
export class NilaiJenisJurusanSekolahComponent implements OnInit {
  listData = {
    header: [],
    field: [],
    action: [],
  ...
  loadData(page: number): void {
    ...
    this.dataService
      .getPostRequest<any>("/pmb/referensi/grade", {
        offset: page,
        limit: this.pageSize,
      })
      .pipe(
