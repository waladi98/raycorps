...
@Component({
  selector: "app-rekap-jas",
  templateUrl: "rekap-jas.component.html",
  styleUrls: ["./rekap-jas.component.scss"],
  styles: [
    `
      md-calendar {
        width: 300px;
...
export class RekapJasComponent implements OnInit {
  ...
  inisialisasiTable() {
    this.listData = {
      ...
      endpoint: "pmb/rekapPesertaJasAlmamater",
      action_name: "",
      type: "",
      ...
      field: [
        ...
        },
        {
          type: "",
          count_field: [],
          class: "text-center border border-black-300 w-48",
          field: "jas_almamater",
        },
        {
          type: "",
