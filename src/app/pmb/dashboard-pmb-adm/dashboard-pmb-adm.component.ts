...
@Component({
  selector: "app-pmb-dashboard-pmb-adm",
  templateUrl: "./dashboard-pmb-adm.component.html",
})
export class DashboardPmbAdmComponent implements OnInit, AfterViewInit {
  ...
  loadCheckLogin() {
    return (this.menu_history = this._storageService.get("hsiotyr"));
  }
