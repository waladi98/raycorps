...
export class DaftarPesertaPMBComponent implements OnInit {
  ...
  verifyData() {
    this.router.navigate(['/pmb/staff/penyaringan-pmb/verifikasi-dokumen/verifikasi-peserta']);
  }

  manageData() {
    this.router.navigate(['/pmb/staff/penyaringan-pmb/verifikasi-dokumen/informasi-lengkap-peserta']);
  }
  ...
  inisialisasiTable(){
    ...
    this.listData = {
      ...
      type: "",
      order: "",
      where: "syarat_lengkap = 'T' AND id is not null",
      group:"",
      ...
      {
        id_params: "formulir_id",
        route: "/pmb/staff/penyaringan-pmb/verifikasi-dokumen/informasi-lengkap-peserta",
        type: "route",
