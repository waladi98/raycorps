...
@Component({
  selector: 'app-komponen-per-jurusan-sekolah',
  templateUrl: 'komponen-per-jurusan-sekolah.component.html',
  styleUrls: ['./komponen-per-jurusan-sekolah.component.scss'],
  styles: [
    `
      md-calendar {
        width: 300px;
...
export class KomponenPerJurusanSekolahComponent implements OnInit {
  ...
  inisialisasiTable() {
    this.listData = {
      ...
      endpoint: 'pmb/master/komponenJurusanSekolah',
      action_name: '',
      type: "",  
      order: "",
      where: "",
      ...
      export:[{
        type:"csv",
        label:"CSV",
        label_report:"report-komponen-per-jurusan-sekolah"
      },
      {
        type:"pdf",
        label:"PDF",
